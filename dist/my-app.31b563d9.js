...
var todos;
if (savedTodosText !== null) todos = JSON.parse(savedTodosText);
else todos = [];
// Funktion: Zeigt die aktuelle Todo-Liste an und speichert sie im localStorage
function render() {
    listContainer.innerHTML = "";
    var listElement = (0, _todoList.TodoList)(todos, toggleTodo, deleteTodo);
...
},{"./components/TodoList":"8K6Dk"}],"8K6Dk":[function(require,module,exports,__globalThis) {
...
function TodoList(todos, onToggle, onDelete) {
    ...
    for(var i = 0; i < todos.length; i++){
        var listItem = (0, _todoItem.TodoItem)(todos[i], i, onToggle, onDelete);
        listElement.appendChild(listItem);
    }
    return listElement;
}

},{"./TodoItem":"6Jjbk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6Jjbk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TodoItem", ()=>TodoItem);
function TodoItem(todo, index, onToggle, onDelete) {
    var listItem = document.createElement("li");
    if (todo.done === true) listItem.className = "done";
...
},{}]},["ihYAY","a0t4e"], "a0t4e", "parcelRequire2bed")

//# sourceMappingURL=my-app.31b563d9.js.map
